...
from utils.point_loader import collation_fn, collation_fn_eval_all
...
def train(gpu, args):
    ...
    if 'front3d' in args.data_name.lower():
        ...
        loader_test = DataLoader(dataset=data_test, batch_size=1,
                                 ...
                                 collate_fn=collation_fn, sampler=sampler_test)
    else:
        loader_train = DataLoader(
            dataset=data_train, batch_size=batch_size,
            num_workers=args.num_threads, pin_memory=True, sampler=sampler_train,
        ...
        loader_val = DataLoader(
            ...
            num_workers=args.num_threads, pin_memory=True, sampler=sampler_val,
            drop_last=False)
        loader_test = DataLoader(dataset=data_test, batch_size=1, drop_last=False, pin_memory=True,
                                 shuffle=False, num_workers=args.num_threads, sampler=sampler_test)
    ...
    if args.model_name == "MRI_":
        ...
        for batch, sample in enumerate(loader_test):
            ...
            if gpu == 0:
                ...
                writer_test.add(loss_val, metric_val)
...
def main(args):
    if not args.test_only:
        ...
        if args.no_multiprocessing:
            ...
            spawn_context = mp.spawn(test, nprocs=args.num_gpus, args=(args,),
                                     join=False)
