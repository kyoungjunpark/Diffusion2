...
class Front3D_1D_Multi_Freq(BaseDataset):
    ...
    def __init__(self, args, mode):
        super(Front3D_1D_Multi_Freq, self).__init__(args, mode)
    ...
    def __getitem__(self, idx):
        ...
        if self.mode in ['train', 'val']:
            ...
            # freq_level = torch.tensor(freq_level)
        ...
        output = {'overshot': overshot, 'heatmap': heatmap, 'freq_level': freq_level, 'data_3d': data_3d, 'room_info': room_info}
    ...
    def _load_data(self, idx):
        ...
        return overshot, heatmap, data_3d, freq_level, room_info
