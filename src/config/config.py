...
parser = argparse.ArgumentParser(description='Diffusion2')
...
parser.add_argument('--data_name',
                    type=str,
                    default='Front3D',
                    choices=('NYU', 'KITTIDC', 'Front3D', 'Front3D_1D', 'Front3D_1D_Multi_Freq', 'Front3D_1D_Video'),
                    help='dataset name')
parser.add_argument('--diffusion_type',
                    type=str,
                    default='DDIM',
                    choices=('DDIM', 'DDPM'),
                    help='diffusion type')
...
parser.add_argument('--model_name',
                    type=str,
                    default='Diffusion_Heatmap_',
                    choices=('NLSPN', 'Diffusion_Heatmap_', 'Diffusion_Heatmap_WO_Backbone_', 'Diffusion_DCbase_', 'Diffusion_DCx4base_',
                             'MRI_', 'NeRF2_', 'Diffusion_Heatmap_Video_'),
                    help='model name')
...
parser.add_argument('--head_specify',
                    ...
                    default=None,
                    choices=(
                    'Video_Diffusion', 'Image_Diffusion',  'Image_Diffusion_FPN'),
                    help='head model name')

parser.add_argument('--premeasured_num',
                    type=int,
                    default=15,
                    help='use premeasured number')
...
parser.add_argument('--loss',
                    type=str,
                    default='1.0*L1+1.0*L2+1.0*DDIM+1.0*MSIG',
...
parser.add_argument('--image_model_path',
                    type=str,
                    default=None,
                    help='image diffusion model path')
...
# Minknet
parser.add_argument('--mink_config', type=str,
                    default='config/mink.yaml',
                    help='mink config file')
parser.add_argument('--mink_pretrained_path', type=str,
                    default=None,
                    help='mink config file')
